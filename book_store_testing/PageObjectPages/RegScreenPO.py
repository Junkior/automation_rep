...
class RegScreen(object):
    def __init__(self, driver):
        self.driver = driver
        self.email_field_registration = driver.find_element(*Locator.email_field_registration)
        self.password_field_registration = driver.find_element(*Locator.password_field_registration)
        self.registration_btn = driver.find_element(*Locator.registration_btn)
        self.login_email_field = driver.find_element(*Locator.login_email_field)
        self.login_password_field = driver.find_element(*Locator.login_password_field)
        self.login_btn = driver.find_element(*Locator.login_btn)
